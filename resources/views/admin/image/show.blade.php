...
@section('title') List Image @endsection
                            ...
                            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <a href="{{ url('admin/image/create') }}">Create New</a>
                                        ...
                                        @foreach($image as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ url('admin/image/' . $item->id . '/edit') }}" class="btn">Edit</a> |
                                                    {{--<a href="{{ url('admin/image/' . $item->id ) }}" class="btn">Delete</a>--}}
